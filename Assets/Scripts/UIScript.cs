...
public class UIScript : MonoBehaviour
{
    ...
    private async System.Threading.Tasks.Task onLoadVRMAsync(AvatarSetting setting)
    {
        ...
        if (path != "")
        {
            ...
            //VRMImporterContext偑VRM傪撉傒崬傓婡擻傪採嫙偟傑偡
            var context = new VRMImporterContext();

            // GLB宍幃偱JSON傪庢摼偟Parse偟傑偡
            context.ParseGlb(bytes);

            // VRM偺儊僞僨乕僞傪庢摼
            var meta = context.ReadMeta(false); //堷悢傪True偵曄偊傞偲僒儉僱僀儖傕撉傒崬傒傑偡

            //撉傒崬傔偨偐偳偆偐儘僌偵儌僨儖柤傪弌椡偟偰傒傞
            ...
            ///
            //撉崬偑姰椆偡傞偲context.Root偵儌僨儖偺GameObject偑擖偭偰偄傑偡
